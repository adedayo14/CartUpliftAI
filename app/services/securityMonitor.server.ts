...
export function logSuspiciousRequest(shop: string, ip: string, userAgent: string, details: Record<string, any>): void {
  securityMonitor.logSecurityEvent({
...
export function securityMiddleware() {
  return async (request: Request, _context: any, next: () => Promise<Response>) => {
